...
public class Book {
    ...
    public static void editbook() {
        int libroedit, parametrolibro, counter = 0;
        boolean bookdelete = false;
        if (!catalogo.isEmpty()) {
            System.out.println("Elija libro a modificar.");
            for (Book b : catalogo) {
                System.out.println(counter + " " + b.getNombre());
                counter++;
            }
    ...
    public static void catalogo() {
        ...
        if (!catalogo.isEmpty()) {
            System.out.println("Los libros disponibles en este momento son:");
            for (Book b : catalogo) {
                System.out.println(counter + " " + b.getNombre());
                counter++;
            }
            int loop = 1;
            do {
                System.out.println("Elija un libro para ver mas informacion. Escriba 99 para cancelar.");
            ...
            System.out.println("En este momento no hay libros en el catalogo.");
        }
    }
}
